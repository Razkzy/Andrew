...
import com.example.collins.stayfit.adapters.HistoryAdapter;
...
public class SessionHistory extends AppCompatActivity {
    ...
    HistoryAdapter myad; //Adapter of history ontext
    ...
    private void fetchHistoryFromDatabase() {
        ...
        //get history context from DB and convert back to string
        while (c.moveToNext()) {
